...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        # Process the classifier label to be in lowercase and stripped of leading/trailing whitespace
        ...
        # Extend the results dictionary list with the classifier label and match result
